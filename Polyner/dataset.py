...
class TrainData(data.Dataset):
    def __init__(self, proj_path, proj_pos_path, num_sample_ray, num_angle, SOD, voxel_size, num_samples):
        ...
        # ray
        self.rays = utils.fan_beam_ray(self.proj_pos, self.SOD, self.num_samples) # (num_det, num_samples, 2)
    ...
    def __getitem__(self, item):
        ...
        ray_sample = self.rays[index:index+self.num_sample_ray]     # (num_sample_ray, num_samples, 2)
