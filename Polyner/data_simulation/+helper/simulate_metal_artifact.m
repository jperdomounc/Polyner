...
for i = 1:n_mask
    ...
    %% Synthesize non-metal poly CT (UNC cone beam with linear detector)
    ...
    % reconstruct (UNC cone beam with linear detector)
    ...
    % gt sinogram (UNC cone beam with linear detector)
